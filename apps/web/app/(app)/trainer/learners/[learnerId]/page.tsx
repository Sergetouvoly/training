// Refs: SPEC.md §7 — formateur : détail d'un apprenant.
// La garde de rôle est assurée par le trainer/layout.tsx.
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <nav className="flex items-center gap-1.5 text-xs text-ink-soft" aria-label="Fil d'Ariane">
        <Link href="/trainer" className="hover:text-primary transition-colors">Espace formateur</Link>
        <span aria-hidden="true">›</span>
        <Link href="/trainer/learners" className="hover:text-primary transition-colors">Apprenants</Link>
        <span aria-hidden="true">›</span>
