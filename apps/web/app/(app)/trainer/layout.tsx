// Refs: docs/BACKLOG.md §2b — chrome unifié (sidebar admin) pour l'espace trainer.
// La sidebar filtre ses items via permissions.can() : un trainer ne voit que
// Modules / Parcours (lecture) / Questions / Apprenants.
